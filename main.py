...
{{"mensaje": "tu respuesta amigable", "accion": "gasto", "datos": {{"fecha": "19/04/2026", "descripcion": "super", "monto": 500, "moneda": "ARS", "categoria": "Comida", "notas": ""}}}}
...
Para vencimientos usa fecha_vencimiento en lugar de fecha, y agrega estado: Pendiente"""
        ...
        if accion == "gasto" and datos:
            ...
            sheet.append_row([datos.get("fecha", datetime.now().strftime("%d/%m/%Y")), datos.get("descripcion", ""), datos.get("monto", 0), datos.get("moneda", "ARS"), datos.get("categoria", "Otros"), datos.get("notas", "")])
            logger.info("Gasto guardado!")
        elif accion == "vencimiento" and datos:
            sheet = spreadsheet.worksheet("Vencimientos")
            sheet.append_row([datos.get("fecha_vencimiento", ""), datos.get("descripcion", ""), datos.get("monto", 0), datos.get("moneda", "ARS"), datos.get("estado", "Pendiente")])
